(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,43875,e=>{"use strict";var t=e.i(74092),a=e.i(43041),s=e.i(63560);let o=(0,e.i(42175).default)("arrow-right",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]);var r=e.i(29114),n=e.i(60409);function i(e,t){n.default.capture("cta_clicked",{cta_name:e,destination:t})}function l({text:e,className:a,delay:s=0}){let o=e.split(" ");return(0,t.jsxs)("span",{className:a,children:[o.map((e,a)=>(0,t.jsx)("span",{className:"inline-block mr-[0.25em]",style:{animation:`fadeInUp 0.5s cubic-bezier(0.16,1,0.3,1) ${s+.08*a}s both`},children:e},a)),(0,t.jsx)("style",{children:`
        @keyframes fadeInUp {
      ...
      `})]})}function h({children:e,className:a="",href:o,glowColor:r="var(--accent)"}){let n=(0,t.jsxs)("div",{className:`group relative overflow-hidden rounded-2xl border p-8 transition-all duration-200 hover:scale-[1.01] ${a}`,style:{background:"var(--bg-surface)",borderColor:"var(--border-subtle)"},children:[(0,t.jsx)("div",{className:"pointer-events-none absolute -inset-px rounded-2xl opacity-0 transition-opacity duration-300 group-hover:opacity-100",style:{background:`radial-gradient(600px circle at var(--mouse-x, 50%) var(--mouse-y, 50%), ${r}10, transparent 40%)`}}),(0,t.jsx)("div",{className:"pointer-events-none absolute inset-x-0 top-0 h-px opacity-0 transition-opacity duration-300 group-hover:opacity-100",style:{background:`linear-gradient(90deg, transparent, ${r}30, transparent)`}}),(0,t.jsx)("div",{className:"relative",children:e})]});return o?o.startsWith("/")?(0,t.jsx)(s.default,{href:o,children:n}):(0,t.jsx)("a",{href:o,target:"_blank",rel:"noopener noreferrer",children:n}):n}let d=["/video/ascii-emergence.mp4","/video/ascii-vortex.mp4"],u=["lorenz","rossler","spiral","flow"],p={lorenz:[129,140,248],rossler:[52,211,153],spiral:[167,139,250],flow:[96,165,250]};function m(){let e=(0,a.useRef)(null),s=(0,a.useRef)(0),o=(0,a.useRef)(null),[r]=(0,a.useState)(()=>d[Math.floor(Math.random()*d.length)]),n=(0,a.useCallback)(e=>{var t;let a=(Date.now()^0xffffffff*Math.random())>>>0,s=(t=a,()=>{t|=0;let e=Math.imul((t=t+0x6d2b79f5|0)^t>>>15,1|t);return(((e=e+Math.imul(e^e>>>7,61|e)^e)^e>>>14)>>>0)/0x100000000}),r=u[Math.floor(s()*u.length)],n=e.width,i=e.height;o.current={particles:Array.from({length:150},()=>({x:s()*n,y:s()*i,vx:(s()-.5)*1.5,vy:(s()-.5)*1.5,life:Math.floor(200*s())+100,maxLife:300})),type:r,seed:a,rng:s,cx1:n*(.3+.4*s()),cy1:i*(.3+.4*s()),cx2:n*(.3+.4*s()),cy2:i*(.3+.4*s()),strength:.015+.02*s()}},[]);return(0,a.useEffect)(()=>{let t=e.current;if(!t)return;let a=t.getContext("2d");if(!a)return;let r=()=>{let e=Math.min(window.devicePixelRatio||1,2),s=t.getBoundingClientRect();t.width=s.width*e,t.height=s.height*e,a.scale(e,e),n(t)};r();let i=()=>{let e=o.current;if(!e||!t)return;let r=t.getBoundingClientRect().width,n=t.getBoundingClientRect().height,l=p[e.type];for(let s of(a.fillStyle="rgba(0, 0, 0, 0.04)",a.fillRect(0,0,r,n),e.particles)){!function(e,t,a,s,o,r,n,i,l,c,h){let d=0,u=0;switch(t){case"lorenz":{let t=a-e.x,i=s-e.y,l=o-e.x,c=r-e.y,h=Math.sqrt(t*t+i*i)+1,p=Math.sqrt(l*l+c*c)+1;d=(t/h-c/p)*n,u=(i/h+l/p)*n;break}case"rossler":{let t=a-e.x,o=s-e.y,r=Math.sqrt(t*t+o*o)+1;d=(-o/r+.008*t)*n,u=(t/r+.008*o)*n;break}case"spiral":{let t=a-e.x,o=s-e.y,r=Math.sqrt(t*t+o*o)+1,i=Math.atan2(o,t)+.4;d=Math.cos(i)/r*n*8,u=Math.sin(i)/r*n*8;break}case"flow":d=Math.sin(.003*e.y+.01*i)*n*.8,u=Math.cos(.003*e.x+.01*i)*n*.8}e.vx+=d,e.vy+=u,e.vx*=.985,e.vy*=.985,e.x+=e.vx,e.y+=e.vy,e.life--,e.life<=0&&(e.x=h()*l,e.y=h()*c,e.vx=(h()-.5)*1.5,e.vy=(h()-.5)*1.5,e.life=Math.floor(200*h())+100),e.x<0&&(e.x+=l),e.x>=l&&(e.x-=l),e.y<0&&(e.y+=c),e.y>=c&&(e.y-=c)}(s,e.type,e.cx1,e.cy1,e.cx2,e.cy2,e.strength,e.seed,t.width,t.height,e.rng);let o=s.life/s.maxLife*.4,i=1+.3*Math.sqrt(s.vx*s.vx+s.vy*s.vy);a.beginPath(),a.arc(s.x/t.width*r,s.y/t.height*n,i,0,2*Math.PI),a.fillStyle=`rgba(${l[0]}, ${l[1]}, ${l[2]}, ${o})`,a.fill()}s.current=requestAnimationFrame(i)};return s.current=requestAnimationFrame(i),window.addEventListener("resize",r),()=>{cancelAnimationFrame(s.current),window.removeEventListener("resize",r)}},[n]),(0,t.jsxs)("div",{className:"pointer-events-none absolute inset-0 overflow-hidden",children:[(0,t.jsx)("div",{className:"absolute inset-0",style:{backgroundImage:"linear-gradient(rgba(255,255,255,0.03) 1px, transparent 1px), linear-gradient(90deg, rgba(255,255,255,0.03) 1px, transparent 1px)",backgroundSize:"64px 64px"}}),(0,t.jsx)("video",{autoPlay:!0,loop:!0,muted:!0,playsInline:!0,className:"absolute inset-0 w-full h-full object-cover opacity-30",style:{mixBlendMode:"screen"},src:r}),(0,t.jsx)("canvas",{ref:e,className:"absolute inset-0 w-full h-full opacity-30",style:{mixBlendMode:"screen"}}),(0,t.jsx)("div",{className:"absolute inset-0",style:{background:"radial-gradient(ellipse 80% 60% at 50% 40%, transparent 0%, rgba(0,0,0,0.7) 100%)"}})]})}var g=e.i(63060),f=e.i(25);function y({text:e,font:s='300 18px "Geist"',lineHeight:o=30,className:r,style:n,fallback:i,cursorRadius:l=36,cursorColor:c="var(--accent)"}){let h=(0,a.useRef)(null),{ready:d,prepareWithSegments:u,layoutNextLine:p}=(0,f.usePreText)("Geist");return((0,a.useEffect)(()=>{if(!d||!u||!p||!h.current)return;let t=h.current,a=u(e,s);if(!a)return;let r=!1,n=0,i=0,m=0,g=0;for(;t.firstChild;)t.removeChild(t.firstChild);let f=[],y=document.createElement("div");function w(e){let s=t.clientWidth;if(0===s)return[];let r={segmentIndex:0,graphemeIndex:0},n=0,i=[],l=0;for(;l++<500;){let t=s,l=0;if(e&&n+o>e.y&&n<e.y+e.height){let a=e.x,o=e.x+e.width;if(a<=0)t=s-(l=Math.max(0,o+12));else if(o>=s)t=Math.max(60,a-12);else{let e=a-12,r=s-o-12;e>=r?t=Math.max(60,e):(l=o+12,t=Math.max(60,r))}}t=Math.max(t,60);let c=r.segmentIndex,h=r.graphemeIndex,d=p(a,r,t);if(!d||(i.push({text:d.text.trimEnd(),y:n,indent:l}),r=d.end,n+=o,r.segmentIndex===c&&r.graphemeIndex===h))break}return i}function v(e){for(var a=e.length;f.length<a;){let e=document.createElement("div");e.style.cssText=`
          position: absolute; white-space: pre; pointer-events: none;
          font: ${s}; line-height: ${o}px; height: ${o}px;
          left: 0; top: 0;
        `,t.appendChild(e),f.push(e)}for(let e=a;e<f.length;e++)f[e].style.display="none";for(let t=0;t<e.length;t++){let a=f[t],s=e[t];a.style.display="block",a.textContent!==s.text&&(a.textContent=s.text),a.style.transform=`translate(${s.indent}px, ${s.y}px)`,a.style.opacity="1"}let r=e.length*o;r>0&&(t.style.height=`${Math.max(r,g)}px`)}y.style.cssText=`
      ...
      z-index: 1;
    `,t.appendChild(y);let b=w(null);g=b.length*o,v(b);for(let e=0;e<f.length;e++)f[e].style.opacity="0",f[e].style.transition="opacity 0.4s ease, transform 0.35s cubic-bezier(0.16, 1, 0.3, 1)";function k(){r=!0,y.style.opacity="0.15",m||I()}function x(e){let a=t.getBoundingClientRect();n=e.clientX-a.left,i=e.clientY-a.top,y.style.transform=`translate(${n-l}px, ${i-l}px)`,r||(r=!0,y.style.opacity="0.15",m||I())}function T(){r=!1,y.style.opacity="0",setTimeout(()=>{r||v(w(null))},300)}function I(){if(!r){m=0;return}m=requestAnimationFrame(I),v(w({x:n-l-14,y:i-l-14,width:(l+14)*2,height:(l+14)*2}))}return requestAnimationFrame(()=>{for(let e=0;e<b.length;e++)setTimeout(()=>{f[e]&&(f[e].style.opacity="1")},80*e)}),t.style.cursor="crosshair",t.addEventListener("pointerenter",k),t.addEventListener("pointermove",x),t.addEventListener("pointerleave",T),()=>{cancelAnimationFrame(m),t.removeEventListener("pointerenter",k),t.removeEventListener("pointermove",x),t.removeEventListener("pointerleave",T)}},[d,e,s,o,u,p,l,c]),d)?(0,t.jsx)("div",{ref:h,className:r,style:{...n,position:"relative",overflow:"visible"}}):(0,t.jsx)("div",{ref:h,className:r,style:n,children:i??e})}let w={segmentIndex:0,graphemeIndex:0};function v({segments:e,className:s,style:o}){let r=(0,a.useRef)(null),[n,i]=(0,a.useState)(0),{ready:l,prepareWithSegments:c,layoutNextLine:h}=(0,f.usePreText)("Geist");(0,a.useEffect)(()=>{if(!r.current)return;let e=()=>{r.current&&i(r.current.clientWidth)};e();let t=new ResizeObserver(e);return t.observe(r.current),()=>t.disconnect()},[]);let d=(0,a.useMemo)(()=>{if(!l||!c||!h||n<=0)return null;let t=e.map(e=>({prepared:c(e.text,e.font),segment:e}));if(t.some(e=>!e.prepared))return null;let a=[],s=Math.max(...e.map(e=>e.lineHeight)),o=0,r=[],i=n;for(let{prepared:e,segment:l}of t){if(!e)continue;let t=h(e,w,1e5);if(t)if(t.width<=i)r.push({text:t.text,width:t.width,style:l.style,font:l.font}),i-=t.width;else{let t=w;for(;;){let c=h(e,t,Math.max(1,i));if(!c)break;if(r.push({text:c.text,width:c.width,style:l.style,font:l.font}),c.end.segmentIndex>=e.segments.length||c.end.segmentIndex===e.segments.length-1&&c.end.graphemeIndex>=e.segments[e.segments.length-1].length){i-=c.width;break}a.push({fragments:r,y:o,lineHeight:s}),o+=s,r=[],i=n,t=c.end}}}return r.length>0&&(a.push({fragments:r,y:o,lineHeight:s}),o+=s),{lines:a,totalHeight:o}},[l,c,h,e,n]);return d?(0,t.jsx)("div",{ref:r,className:s,style:{...o,position:"relative",height:`${d.totalHeight}px`},children:d.lines.map((e,a)=>(0,t.jsx)("div",{style:{position:"absolute",top:`${e.y}px`,left:0,height:`${e.lineHeight}px`,lineHeight:`${e.lineHeight}px`,whiteSpace:"pre"},children:e.fragments.map((e,a)=>(0,t.jsx)("span",{style:{...e.style,font:e.font},children:e.text},a))},a))}):(0,t.jsx)("div",{ref:r,className:s,style:{...o,whiteSpace:"pre-wrap"},children:e.map((e,a)=>(0,t.jsx)("span",{style:{...e.style,font:e.font},children:e.text},a))})}function b({text:e,font:s='300 14px "Geist"',lineHeight:o=24,orbCount:r=3,orbRadius:n=40,className:i,style:l,textColor:c="var(--text-secondary)"}){let{ready:h,prepareWithSegments:d,layoutNextLine:u}=(0,f.usePreText)("Geist"),p=(0,a.useRef)(null),m=(0,a.useRef)(null),g=(0,a.useRef)(null),y=(0,a.useRef)([]),w=(0,a.useRef)(0),[v,k]=(0,a.useState)({width:0,height:0}),x=(0,a.useRef)(-1),T=(0,a.useRef)({x:0,y:0});(0,a.useEffect)(()=>{if(0===v.width)return;let e=v.width,t=v.height||300,a=["rgba(129,140,248,0.12)","rgba(34,197,94,0.10)","rgba(129,140,248,0.08)"];y.current=Array.from({length:r},(s,o)=>({x:e*(.25+.5*Math.random()),y:t*(.25+.5*Math.random()),vx:(Math.random()-.5)*1.5,vy:(Math.random()-.5)*1.5,radius:n+15*Math.random(),color:a[o%a.length],dragging:!1}))},[v.width,v.height,r,n]),(0,a.useEffect)(()=>{if(!p.current)return;let e=()=>{if(p.current){let{width:e}=p.current.getBoundingClientRect();k({width:e,height:280})}};e();let t=new ResizeObserver(e);return t.observe(p.current),()=>t.disconnect()},[h]),(0,a.useEffect)(()=>{if(!h||!d||!u||0===v.width)return;let t=d(e,s);if(!t)return;let a=m.current,r=g.current;if(!a||!r)return;let n=a.getContext("2d");if(!n)return;let i=v.width,l=window.devicePixelRatio||1,p=()=>{let e=y.current;for(let t of e)!t.dragging&&(t.x+=t.vx,t.y+=t.vy,t.x-t.radius<0&&(t.x=t.radius,t.vx*=-.8),t.x+t.radius>i&&(t.x=i-t.radius,t.vx*=-.8),t.y-t.radius<0&&(t.y=t.radius,t.vy*=-.8),t.vx*=.999,t.vy*=.999,.3>Math.sqrt(t.vx*t.vx+t.vy*t.vy)&&(t.vx+=(Math.random()-.5)*.2,t.vy+=(Math.random()-.5)*.2));for(let t=0;t<e.length;t++)for(let a=t+1;a<e.length;a++){let s=e[t],o=e[a],r=o.x-s.x,n=o.y-s.y,i=Math.sqrt(r*r+n*n),l=s.radius+o.radius;if(i<l&&i>0){let e=r/i,t=n/i,a=(l-i)/2;s.dragging||(s.x-=e*a,s.y-=t*a),o.dragging||(o.x+=e*a,o.y+=t*a);let c=(o.vx-s.vx)*e+(o.vy-s.vy)*t;s.dragging||(s.vx+=c*e*.5,s.vy+=c*t*.5),o.dragging||(o.vx-=c*e*.5,o.vy-=c*t*.5)}}let h=[],d={segmentIndex:0,graphemeIndex:0},m=0,g=t.segments.length,f=200;for(;(d.segmentIndex<g||d.graphemeIndex>0)&&m<280&&f-- >0;){let a=0,s=i;for(let t of e){let e=t.y-t.radius,r=t.y+t.radius;if(m+o>e&&m<r){let e=m+o/2-t.y,r=Math.sqrt(Math.max(0,t.radius*t.radius-e*e)),n=t.x-r-8,l=t.x+r+8,c=Math.max(0,n),h=Math.max(0,i-l);if(c>=h&&c>60)s=c,a=0;else if(h>60)a=l,s=h;else{m+=o;continue}}}if(s<40){m+=o;continue}let r=u(t,d,s);if(!r||r.end.segmentIndex===d.segmentIndex&&r.end.graphemeIndex===d.graphemeIndex)break;r.text.trim()&&h.push({x:a,y:m,text:r.text}),d=r.end,m+=o}for(let t of(a.width=i*l,a.height=280*l,a.style.width=`${i}px`,a.style.height="280px",n.scale(l,l),n.clearRect(0,0,i,280),e)){let e=n.createRadialGradient(t.x,t.y,0,t.x,t.y,t.radius);e.addColorStop(0,t.color.replace(/[\d.]+\)$/,"0.15)")),e.addColorStop(.7,t.color),e.addColorStop(1,"transparent"),n.beginPath(),n.arc(t.x,t.y,t.radius,0,2*Math.PI),n.fillStyle=e,n.fill(),n.beginPath(),n.arc(t.x,t.y,t.radius,0,2*Math.PI),n.strokeStyle=t.color.replace(/[\d.]+\)$/,"0.3)"),n.lineWidth=1,n.stroke()}for(let e of(r.innerHTML="",r.style.height="280px",h)){let t=document.createElement("div");t.style.position="absolute",t.style.left=`${e.x}px`,t.style.top=`${e.y}px`,t.style.font=s,t.style.color=c,t.style.whiteSpace="nowrap",t.style.lineHeight=`${o}px`,t.textContent=e.text,r.appendChild(t)}for(let t of e)t.y+t.radius>270&&(t.y=280-t.radius-10,t.vy*=-.8);w.current=requestAnimationFrame(p)};return w.current=requestAnimationFrame(p),()=>cancelAnimationFrame(w.current)},[h,d,u,v.width,e,s,o,c]);let I=(0,a.useCallback)(e=>{let t=p.current?.getBoundingClientRect();if(!t)return;let a=e.clientX-t.left,s=e.clientY-t.top;for(let t=0;t<y.current.length;t++){let o=y.current[t],r=a-o.x,n=s-o.y;if(r*r+n*n<o.radius*o.radius){x.current=t,T.current={x:r,y:n},o.dragging=!0,o.vx=0,o.vy=0,e.target.setPointerCapture(e.pointerId);return}}},[]),C=(0,a.useCallback)(e=>{if(x.current<0)return;let t=p.current?.getBoundingClientRect();if(!t)return;let a=y.current[x.current];a&&(a.x=e.clientX-t.left-T.current.x,a.y=e.clientY-t.top-T.current.y)},[]),A=(0,a.useCallback)(()=>{if(x.current>=0){let e=y.current[x.current];e&&(e.dragging=!1)}x.current=-1},[]);return h?(0,t.jsxs)("div",{ref:p,className:i,style:{...l,position:"relative",height:280,overflow:"hidden",cursor:"default"},onPointerDown:I,onPointerMove:C,onPointerUp:A,children:[(0,t.jsx)("canvas",{ref:m,style:{position:"absolute",top:0,left:0,zIndex:0,pointerEvents:"none"}}),(0,t.jsx)("div",{ref:g,style:{position:"absolute",top:0,left:0,width:"100%",zIndex:1,pointerEvents:"none"}})]}):(0,t.jsx)("div",{className:i,style:l,children:(0,t.jsx)("p",{style:{color:c,font:s,lineHeight:`${o}px`},children:e})})}var k=e.i(81154);let x="utm_source=edgelesslab&utm_medium=website&utm_campaign=products",T=[{name:"CLAUDE.md Template Pack",price:"Free",description:"14 battle-tested CLAUDE.md templates for every project type. Drop one into your repo and start building.",features:["14 templates: iOS, Android, ML, API, DevOps, Next.js, and more","CLI Tools, Monorepos, and Game Dev configurations","Embedded/IoT, Security Audits, and Open Source templates","Startup MVP and Technical Writing presets"],href:`https://edgelessai.gumroad.com/l/kszapk?${x}`,badge:"Free"},{name:"Quick Reference Cards",price:"Free",description:"Printable cheat sheets for prompt patterns, Claude Code shortcuts, MCP tool reference, and common workflows.",features:["Prompt pattern and system prompt reference cards","Claude Code shortcuts and slash commands","Token optimization and temperature settings guide","PDF and markdown formats, pin-next-to-monitor ready"],href:`https://edgelessai.gumroad.com/l/dihxts?${x}`,badge:"Free"},{name:"Claude Code Cheat Sheet",price:"Free",description:"Quick-start reference for Claude Code. Commands, shortcuts, hook patterns, and MCP setup in one printable sheet.",features:["All slash commands and keyboard shortcuts","Hook configuration patterns with examples","MCP server setup cheatsheet","CLAUDE.md template and memory system quick-start"],href:`https://edgelessai.gumroad.com/l/claude-code-cheat-sheet?${x}`,badge:"Free",slug:"claude-code-cheat-sheet"},{name:"Claude Memory Kit",price:"Free",description:"Start here. Drop-in memory template for Claude Code. Persists context, feedback, and project knowledge across conversations.",features:["4 memory types: user, feedback, project, reference","MEMORY.md index auto-loaded each session","CLAUDE.md snippet for instant setup","Real-world examples included"],href:"https://github.com/edgeless-ai/claude-memory-kit?utm_source=edgelesslab&utm_medium=website&utm_campaign=products",badge:"Free",repoUrl:"https://github.com/edgeless-ai/claude-memory-kit"},{name:"Edgeless Stack",price:"Free",description:"The complete AI agent infrastructure. Memory that persists, hooks that protect, skills that compound, and agents that run while you sleep. Extracted from 3+ months of production use.",features:["3-layer memory: SQLite ledger + ChromaDB vectors + Obsidian vault","6 safety hooks: damage control, completion verification, taxonomy guard","9 skills with tiered loading (5 core + 4 domain)","Cron patterns, Agent Bus, Docker compose, install.sh"],href:"https://github.com/edgeless-ai/edgeless-stack?utm_source=edgelesslab&utm_medium=website&utm_campaign=products",badge:"Free",repoUrl:"https://github.com/edgeless-ai/edgeless-stack"},{name:"Multi-Agent Orchestration Blueprint",price:"$39",description:"The dispatch/worker architecture for coordinating multiple AI agents. Agent Bus messaging, async inboxes, state machines, and 3 reference implementations from a system that runs 5 agents 24/7.",features:["Dispatch/worker topology: routing tasks to specialist agents","Agent Bus setup: real-time inter-session messaging patterns","State machines: queued -> acked -> running -> done/failed","3 reference pipelines: research, code review, content processing"],href:`https://edgelessai.gumroad.com/l/multi-agent-blueprint?${x}`,badge:"New",comingSoon:!1,slug:"multi-agent-blueprint"},{name:"The Agent Cookbook",price:"$39",description:"Build AI agents that actually work. 15 production-ready agent patterns with complete implementations for Claude, GPT, and open-source models.",features:["15 production-ready agent patterns with working code","Memory systems, tool integration, and context management","Error recovery and deployment strategies","Architecture diagrams and production lessons learned"],href:`https://edgelessai.gumroad.com/l/plbzo?${x}`,badge:null},{name:"Claude Memory Kit Pro",price:"$29",description:"The complete memory system for Claude Code power users. 12 templates, 5 stack libraries, advanced patterns guide, and CLAUDE.md templates.",features:["12 ready-to-customize memory templates","Stack libraries: React/Next.js, Python/FastAPI, Go, Rails, Rust","Advanced patterns: multi-project, team memory, CI integration","CLAUDE.md templates for solo and monorepo projects"],href:`https://edgelessai.gumroad.com/l/claude-memory-kit?${x}`,badge:"Popular"},{name:"The Prompt Engineering OS",price:"$29",description:"The complete system for writing AI prompts that work in production. 30 chapters, 8 template schemas, 100+ templates.",features:["30 chapters covering every prompt pattern","8 template schemas with fill-in-the-blank structure","100+ production-tested prompt templates","Covers Claude, GPT-4, Gemini, and open models"],href:`https://edgelessai.gumroad.com/l/prompt-engineering-os?${x}`,badge:null},{name:"Generative Art Starter Kit",price:"$29",description:"10 Python generators for pen plotters: flow fields, L-systems, Voronoi, spirals, reaction-diffusion. Each with parameter guides, example SVGs, and AI scoring rubrics from 105+ experiments.",features:["10 generators with source code, parameter guides, and 3 example outputs each","SVG optimization for pen plotters: stroke ordering, travel minimization","AI scoring rubric for evaluating generative art quality","Print-ready export: A4, A3, letter sizes with plotter setup guides"],href:`https://edgelessai.gumroad.com/l/gen-art-starter?${x}`,badge:"New",comingSoon:!1,slug:"gen-art-starter"},{name:"Always-On Agent Deployment Kit",price:"$29",description:"Deploy an AI agent that runs 24/7 on a $5 VPS. Cron scheduling, grounding packets, memory contracts, Telegram alerting, and the recovery patterns from 3 months of unattended operation.",features:["VPS setup guide: Hetzner, systemd, PM2, environment hardening","Cron job architecture: health checks, email triage, knowledge consolidation","Grounding stack: verification layers, evidence-based completion, session packets","Communication patterns: Telegram bot, inbox dispatch, API access"],href:`https://edgelessai.gumroad.com/l/always-on-agent?${x}`,badge:"New",comingSoon:!0,slug:"always-on-agent"},{name:"Production MCP Server Kit",price:"$29",description:"Take MCP servers past the tutorial stage. Auth middleware, rate limiting, Docker deployment, health checks, and error handling patterns from running 4+ MCP servers in production.",features:["Auth middleware: API key validation and OAuth2 token checking","Rate limiting, usage tracking, and health check endpoints","Docker + compose deployment configs with monitoring","3 production server examples: filesystem, database, external API"],href:`https://edgelessai.gumroad.com/l/production-mcp-kit?${x}`,badge:"New",comingSoon:!1,slug:"production-mcp-kit"},{name:"AI Code Review Playbook",price:"$24",description:"Systematic AI-powered code review that catches security vulnerabilities, performance issues, and logic errors before they ship.",features:["Review checklists and prompt templates for Claude/GPT","GitHub Actions and CI/CD integration guides","Security vulnerability and performance issue detection","Built from real experience reviewing thousands of PRs"],href:`https://edgelessai.gumroad.com/l/uacjr?${x}`,badge:null},{name:"Digital Product Launch Toolkit",price:"$24",description:"The exact process used to ship 18 digital products as a solo developer. Gumroad page templates, pricing strategy, launch checklists, and the daily shipping workflow.",features:["3 Gumroad page layouts: simple, detailed, and premium tiers","Pricing strategy guide: why $9/$14/$19/$24/$29/$39 tiers work","18-step launch checklist from idea to live listing","Cross-sell and bundle strategies with real revenue examples"],href:`https://edgelessai.gumroad.com/l/launch-toolkit?${x}`,badge:"New",comingSoon:!1,slug:"launch-toolkit"},{name:"n8n AI Workflow Templates",price:"$24",description:"5 importable n8n workflows that connect AI to real business processes. YouTube monitoring, RSS intelligence, AI code review, content embedding, and scheduled health checks.",features:["5 ready-to-import n8n workflow JSON files","YouTube monitor -> Claude summary -> email digest pipeline","RSS aggregator -> AI analysis -> Telegram notification","Docker n8n setup guide with environment configuration"],href:`https://edgelessai.gumroad.com/l/n8n-ai-workflows?${x}`,badge:"New",comingSoon:!1,slug:"n8n-ai-workflows"},{name:"MCP Server Starter Kit",price:"$24",description:"TypeScript and Python templates for building MCP servers. Go from zero to a running server in under an hour.",features:["TypeScript and Python server templates","8-chapter guide from architecture to deployment","3 working example servers: file search, database query, API proxy","Complete build-to-deploy walkthrough"],href:`https://edgelessai.gumroad.com/l/lixicg?${x}`,badge:null},{name:"Obsidian + Claude Code Setup Kit",price:"$19",description:"Turn Obsidian into an AI-powered development environment with pre-configured vault, Claude Code integration, and workflow automations.",features:["Pre-configured vault with Claude Code integration","CLAUDE.md templates and hook configurations","Custom templates and plugin recommendations","Complete knowledge management system for AI developers"],href:`https://edgelessai.gumroad.com/l/fyuwpn?${x}`,badge:null},{name:"Prompt Testing Framework",price:"$19",description:"Regression testing, A/B comparison templates, and quality scoring rubrics for AI prompts. Built for teams shipping AI features.",features:["Regression testing and A/B comparison templates","Quality scoring rubrics with structured evaluation criteria","Test harnesses for Claude, GPT, and Gemini","Repeatable, measurable prompt quality workflows"],href:`https://edgelessai.gumroad.com/l/yrail?${x}`,badge:null},{name:"Autonomous Agent Safety Patterns",price:"$19",description:"Hard-won guardrails from an agent that lost $252 of real money. Financial verification protocols, destructive operation prevention, scope containment, and the incident response playbook.",features:["Full post-mortem: the $252 USDC loss and what changed after","10 anti-patterns with production fixes and hook implementations","Financial transaction verification protocol (test small, verify, confirm)","Scope containment patterns: keeping agents within boundaries"],href:`https://edgelessai.gumroad.com/l/agent-safety-patterns?${x}`,badge:"New",comingSoon:!1,slug:"agent-safety-patterns"},{name:"Claude Code Hooks Deep Dive",price:"$19",description:"15 production hooks beyond the basics. The damage-control hook that blocks destructive commands. The verify-completion hook that won't let you lie about finishing. Session init, memory flush, pre-commit guards.",features:["15 battle-tested hooks with full source and walkthroughs","damage-control.py: the hook that saved the codebase from rm -rf","Hook composition patterns: chaining, conditional, env-aware","Template hooks for common scenarios you can customize in minutes"],href:`https://edgelessai.gumroad.com/l/hooks-deep-dive?${x}`,badge:"New",comingSoon:!1,slug:"hooks-deep-dive"},{name:"Hooks Library",price:"$14",description:"24 production-ready hooks across 6 categories. Drop in, configure, ship.",features:["Quality hooks: linting, testing, secrets detection","Safety hooks: damage control, backup, force-push guard","Integration hooks: Slack, Telegram, Linear, Obsidian","AI hooks: context preload, completion verify, cost tracking"],href:`https://edgelessai.gumroad.com/l/ztaflt?${x}`,badge:null}];k.PLOTTER.pieces,k.PLOTTER.factories,k.PLOTTER.factories,k.PLOTTER.factories,k.PLOTTER.pieces,k.PLOTTER.factories,k.PLOTTER.pieces,k.PLOTTER.best,k.PLOTTER.factories,k.PLOTTER.pieces,k.PLOTTER.kept,k.PLOTTER.kept,k.PLOTTER.factories,k.PLOTTER.pieces,k.PLOTTER.best,k.PLOTTER.kept;let I=[{slug:"hermes-curator-skill-lifecycle",editorial:!0,title:"Hermes Curator: The Agent That Cleans Up After Your Agents",description:"Nous Research shipped Hermes v0.12.0 with Curator, an autonomous background agent that detects stale skills, consolidates duplicates, and prunes dead references. Here's why it matters for multi-agent systems.",date:"2026-05-01",tags:["Hermes","AI Agents","Skill Management","Multi-Agent"],readTime:"4 min",productSlug:"multi-agent-blueprint",ctaHook:"The dispatch pattern, skill architecture, and reference implementations for building your own self-maintaining agent system.",content:`
...
Everything on the [products page](/products).
    `.trim()},{slug:"generative-art-algorithms-that-work",productSlug:"gen-art-starter",ctaHook:"Working generators for every algorithm in this post, plus SVG optimization scripts.",isLaunch:!0,title:"I Built 75 Generative Art Algorithms. These 10 Actually Look Good.",description:"Most generative art looks like noise. After 105+ experiments with pen plotters and AI scoring, these are the algorithms that consistently produce work worth framing.",date:"2026-04-08",tags:["Generative Art","Pen Plotters","Creative Coding"],readTime:"6 min",content:`
