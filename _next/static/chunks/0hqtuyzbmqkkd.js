(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,43875,e=>{"use strict";var t=e.i(74092),a=e.i(43041),s=e.i(63560);let r=(0,e.i(42175).default)("arrow-right",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]);var o=e.i(29114),n=e.i(60409);function i(e,t){n.default.capture("cta_clicked",{cta_name:e,destination:t})}function l({text:e,className:a,delay:s=0}){let r=e.split(" ");return(0,t.jsxs)("span",{className:a,children:[r.map((e,a)=>(0,t.jsx)("span",{className:"inline-block mr-[0.25em]",style:{animation:`fadeInUp 0.5s cubic-bezier(0.16,1,0.3,1) ${s+.08*a}s both`},children:e},a)),(0,t.jsx)("style",{children:`
      ...
      `})]})}var u=e.i(25);function p({text:e,font:s='300 18px "Geist"',lineHeight:r=30,className:o,style:n,fallback:i,cursorRadius:l=36,cursorColor:c="var(--accent)"}){let d=(0,a.useRef)(null),{ready:h,prepareWithSegments:m,layoutNextLine:g}=(0,u.usePreText)("Geist");return((0,a.useEffect)(()=>{if(!h||!m||!g||!d.current)return;let t=d.current,a=m(e,s);if(!a)return;let o=!1,n=0,i=0,u=0,p=0;for(;t.firstChild;)t.removeChild(t.firstChild);let f=[],y=document.createElement("div");function b(e){let s=t.clientWidth;if(0===s)return[];let o={segmentIndex:0,graphemeIndex:0},n=0,i=[],l=0;for(;l++<500;){let t=s,l=0;if(e&&n+r>e.y&&n<e.y+e.height){let a=e.x,r=e.x+e.width;if(a<=0)t=s-(l=Math.max(0,r+12));else if(r>=s)t=Math.max(60,a-12);else{let e=a-12,o=s-r-12;e>=o?t=Math.max(60,e):(l=r+12,t=Math.max(60,o))}}t=Math.max(t,60);let c=o.segmentIndex,d=o.graphemeIndex,h=g(a,o,t);if(!h||(i.push({text:h.text.trimEnd(),y:n,indent:l}),o=h.end,n+=r,o.segmentIndex===c&&o.graphemeIndex===d))break}return i}function v(e){for(var a=e.length;f.length<a;){let e=document.createElement("div");e.style.cssText=`
          position: absolute; white-space: pre; pointer-events: none;
          font: ${s}; line-height: ${r}px; height: ${r}px;
          left: 0; top: 0;
        `,t.appendChild(e),f.push(e)}for(let e=a;e<f.length;e++)f[e].style.display="none";for(let t=0;t<e.length;t++){let a=f[t],s=e[t];a.style.display="block",a.textContent!==s.text&&(a.textContent=s.text),a.style.transform=`translate(${s.indent}px, ${s.y}px)`,a.style.opacity="1"}let o=e.length*r;o>0&&(t.style.height=`${Math.max(o,p)}px`)}y.style.cssText=`
      ...
      z-index: 1;
    `,t.appendChild(y);let w=b(null);p=w.length*r,v(w);for(let e=0;e<f.length;e++)f[e].style.opacity="0",f[e].style.transition="opacity 0.4s ease, transform 0.35s cubic-bezier(0.16, 1, 0.3, 1)";function x(){o=!0,y.style.opacity="0.15",u||I()}function k(e){let a=t.getBoundingClientRect();n=e.clientX-a.left,i=e.clientY-a.top,y.style.transform=`translate(${n-l}px, ${i-l}px)`,o||(o=!0,y.style.opacity="0.15",u||I())}function T(){o=!1,y.style.opacity="0",setTimeout(()=>{o||v(b(null))},300)}function I(){if(!o){u=0;return}u=requestAnimationFrame(I),v(b({x:n-l-14,y:i-l-14,width:(l+14)*2,height:(l+14)*2}))}return requestAnimationFrame(()=>{for(let e=0;e<w.length;e++)setTimeout(()=>{f[e]&&(f[e].style.opacity="1")},80*e)}),t.style.cursor="crosshair",t.addEventListener("pointerenter",x),t.addEventListener("pointermove",k),t.addEventListener("pointerleave",T),()=>{cancelAnimationFrame(u),t.removeEventListener("pointerenter",x),t.removeEventListener("pointermove",k),t.removeEventListener("pointerleave",T)}},[h,e,s,r,m,g,l,c]),h)?(0,t.jsx)("div",{ref:d,className:o,style:{...n,position:"relative",overflow:"visible"}}):(0,t.jsx)("div",{ref:d,className:o,style:n,children:i??e})}let m={segmentIndex:0,graphemeIndex:0};function g({segments:e,className:s,style:r}){let o=(0,a.useRef)(null),[n,i]=(0,a.useState)(0),{ready:l,prepareWithSegments:c,layoutNextLine:d}=(0,u.usePreText)("Geist");(0,a.useEffect)(()=>{if(!o.current)return;let e=()=>{o.current&&i(o.current.clientWidth)};e();let t=new ResizeObserver(e);return t.observe(o.current),()=>t.disconnect()},[]);let h=(0,a.useMemo)(()=>{if(!l||!c||!d||n<=0)return null;let t=e.map(e=>({prepared:c(e.text,e.font),segment:e}));if(t.some(e=>!e.prepared))return null;let a=[],s=Math.max(...e.map(e=>e.lineHeight)),r=0,o=[],i=n;for(let{prepared:e,segment:l}of t){if(!e)continue;let t=d(e,m,1e5);if(t)if(t.width<=i)o.push({text:t.text,width:t.width,style:l.style,font:l.font}),i-=t.width;else{let t=m;for(;;){let c=d(e,t,Math.max(1,i));if(!c)break;if(o.push({text:c.text,width:c.width,style:l.style,font:l.font}),c.end.segmentIndex>=e.segments.length||c.end.segmentIndex===e.segments.length-1&&c.end.graphemeIndex>=e.segments[e.segments.length-1].length){i-=c.width;break}a.push({fragments:o,y:r,lineHeight:s}),r+=s,o=[],i=n,t=c.end}}}return o.length>0&&(a.push({fragments:o,y:r,lineHeight:s}),r+=s),{lines:a,totalHeight:r}},[l,c,d,e,n]);return h?(0,t.jsx)("div",{ref:o,className:s,style:{...r,position:"relative",height:`${h.totalHeight}px`},children:h.lines.map((e,a)=>(0,t.jsx)("div",{style:{position:"absolute",top:`${e.y}px`,left:0,height:`${e.lineHeight}px`,lineHeight:`${e.lineHeight}px`,whiteSpace:"pre"},children:e.fragments.map((e,a)=>(0,t.jsx)("span",{style:{...e.style,font:e.font},children:e.text},a))},a))}):(0,t.jsx)("div",{ref:o,className:s,style:{...r,whiteSpace:"pre-wrap"},children:e.map((e,a)=>(0,t.jsx)("span",{style:{...e.style,font:e.font},children:e.text},a))})}function f({text:e,font:s='300 14px "Geist"',lineHeight:r=24,orbCount:o=3,orbRadius:n=40,className:i,style:l,textColor:c="var(--text-secondary)"}){let{ready:d,prepareWithSegments:h,layoutNextLine:p}=(0,u.usePreText)("Geist"),m=(0,a.useRef)(null),g=(0,a.useRef)(null),y=(0,a.useRef)(null),b=(0,a.useRef)([]),v=(0,a.useRef)(0),[w,x]=(0,a.useState)({width:0,height:0}),k=(0,a.useRef)(-1),T=(0,a.useRef)({x:0,y:0});(0,a.useEffect)(()=>{if(0===w.width)return;let e=w.width,t=w.height||300,a=["rgba(129,140,248,0.12)","rgba(34,197,94,0.10)","rgba(129,140,248,0.08)"];b.current=Array.from({length:o},(s,r)=>({x:e*(.25+.5*Math.random()),y:t*(.25+.5*Math.random()),vx:(Math.random()-.5)*1.5,vy:(Math.random()-.5)*1.5,radius:n+15*Math.random(),color:a[r%a.length],dragging:!1}))},[w.width,w.height,o,n]),(0,a.useEffect)(()=>{if(!m.current)return;let e=()=>{if(m.current){let{width:e}=m.current.getBoundingClientRect();x({width:e,height:280})}};e();let t=new ResizeObserver(e);return t.observe(m.current),()=>t.disconnect()},[d]),(0,a.useEffect)(()=>{if(!d||!h||!p||0===w.width)return;let t=h(e,s);if(!t)return;let a=g.current,o=y.current;if(!a||!o)return;let n=a.getContext("2d");if(!n)return;let i=w.width,l=window.devicePixelRatio||1,u=()=>{let e=b.current;for(let t of e)!t.dragging&&(t.x+=t.vx,t.y+=t.vy,t.x-t.radius<0&&(t.x=t.radius,t.vx*=-.8),t.x+t.radius>i&&(t.x=i-t.radius,t.vx*=-.8),t.y-t.radius<0&&(t.y=t.radius,t.vy*=-.8),t.vx*=.999,t.vy*=.999,.3>Math.sqrt(t.vx*t.vx+t.vy*t.vy)&&(t.vx+=(Math.random()-.5)*.2,t.vy+=(Math.random()-.5)*.2));for(let t=0;t<e.length;t++)for(let a=t+1;a<e.length;a++){let s=e[t],r=e[a],o=r.x-s.x,n=r.y-s.y,i=Math.sqrt(o*o+n*n),l=s.radius+r.radius;if(i<l&&i>0){let e=o/i,t=n/i,a=(l-i)/2;s.dragging||(s.x-=e*a,s.y-=t*a),r.dragging||(r.x+=e*a,r.y+=t*a);let c=(r.vx-s.vx)*e+(r.vy-s.vy)*t;s.dragging||(s.vx+=c*e*.5,s.vy+=c*t*.5),r.dragging||(r.vx-=c*e*.5,r.vy-=c*t*.5)}}let d=[],h={segmentIndex:0,graphemeIndex:0},m=0,g=t.segments.length,f=200;for(;(h.segmentIndex<g||h.graphemeIndex>0)&&m<280&&f-- >0;){let a=0,s=i;for(let t of e){let e=t.y-t.radius,o=t.y+t.radius;if(m+r>e&&m<o){let e=m+r/2-t.y,o=Math.sqrt(Math.max(0,t.radius*t.radius-e*e)),n=t.x-o-8,l=t.x+o+8,c=Math.max(0,n),d=Math.max(0,i-l);if(c>=d&&c>60)s=c,a=0;else if(d>60)a=l,s=d;else{m+=r;continue}}}if(s<40){m+=r;continue}let o=p(t,h,s);if(!o||o.end.segmentIndex===h.segmentIndex&&o.end.graphemeIndex===h.graphemeIndex)break;o.text.trim()&&d.push({x:a,y:m,text:o.text}),h=o.end,m+=r}for(let t of(a.width=i*l,a.height=280*l,a.style.width=`${i}px`,a.style.height="280px",n.scale(l,l),n.clearRect(0,0,i,280),e)){let e=n.createRadialGradient(t.x,t.y,0,t.x,t.y,t.radius);e.addColorStop(0,t.color.replace(/[\d.]+\)$/,"0.15)")),e.addColorStop(.7,t.color),e.addColorStop(1,"transparent"),n.beginPath(),n.arc(t.x,t.y,t.radius,0,2*Math.PI),n.fillStyle=e,n.fill(),n.beginPath(),n.arc(t.x,t.y,t.radius,0,2*Math.PI),n.strokeStyle=t.color.replace(/[\d.]+\)$/,"0.3)"),n.lineWidth=1,n.stroke()}for(let e of(o.innerHTML="",o.style.height="280px",d)){let t=document.createElement("div");t.style.position="absolute",t.style.left=`${e.x}px`,t.style.top=`${e.y}px`,t.style.font=s,t.style.color=c,t.style.whiteSpace="nowrap",t.style.lineHeight=`${r}px`,t.textContent=e.text,o.appendChild(t)}for(let t of e)t.y+t.radius>270&&(t.y=280-t.radius-10,t.vy*=-.8);v.current=requestAnimationFrame(u)};return v.current=requestAnimationFrame(u),()=>cancelAnimationFrame(v.current)},[d,h,p,w.width,e,s,r,c]);let I=(0,a.useCallback)(e=>{let t=m.current?.getBoundingClientRect();if(!t)return;let a=e.clientX-t.left,s=e.clientY-t.top;for(let t=0;t<b.current.length;t++){let r=b.current[t],o=a-r.x,n=s-r.y;if(o*o+n*n<r.radius*r.radius){k.current=t,T.current={x:o,y:n},r.dragging=!0,r.vx=0,r.vy=0,e.target.setPointerCapture(e.pointerId);return}}},[]),C=(0,a.useCallback)(e=>{if(k.current<0)return;let t=m.current?.getBoundingClientRect();if(!t)return;let a=b.current[k.current];a&&(a.x=e.clientX-t.left-T.current.x,a.y=e.clientY-t.top-T.current.y)},[]),P=(0,a.useCallback)(()=>{if(k.current>=0){let e=b.current[k.current];e&&(e.dragging=!1)}k.current=-1},[]);return d?(0,t.jsxs)("div",{ref:m,className:i,style:{...l,position:"relative",height:280,overflow:"hidden",cursor:"default"},onPointerDown:I,onPointerMove:C,onPointerUp:P,children:[(0,t.jsx)("canvas",{ref:g,style:{position:"absolute",top:0,left:0,zIndex:0,pointerEvents:"none"}}),(0,t.jsx)("div",{ref:y,style:{position:"absolute",top:0,left:0,width:"100%",zIndex:1,pointerEvents:"none"}})]}):(0,t.jsx)("div",{className:i,style:l,children:(0,t.jsx)("p",{style:{color:c,font:s,lineHeight:`${r}px`},children:e})})}var y=e.i(81154);let b="utm_source=edgelesslab&utm_medium=website&utm_campaign=products",v=[{name:"Multi-Agent Orchestration Blueprint",price:"$39",description:"The dispatch/worker architecture for coordinating multiple AI agents. Agent Bus messaging, async inboxes, state machines, and 3 reference implementations from a system that runs 5 agents 24/7.",features:["Dispatch/worker topology: routing tasks to specialist agents","Agent Bus setup: real-time inter-session messaging patterns","State machines: queued -> acked -> running -> done/failed","3 reference pipelines: research, code review, content processing"],href:`https://edgelessai.gumroad.com/l/multi-agent-blueprint?${b}`,badge:"New",comingSoon:!1,slug:"multi-agent-blueprint"},{name:"The Agent Cookbook",price:"$39",description:"Build AI agents that actually work. 15 production-ready agent patterns with complete implementations for Claude, GPT, and open-source models.",features:["15 production-ready agent patterns with working code","Memory systems, tool integration, and context management","Error recovery and deployment strategies","Architecture diagrams and production lessons learned"],href:`https://edgelessai.gumroad.com/l/plbzo?${b}`,badge:null},{name:"Claude Memory Kit Pro",price:"$29",description:"The complete memory system for Claude Code power users. 12 templates, 5 stack libraries, advanced patterns guide, and CLAUDE.md templates.",features:["12 ready-to-customize memory templates","Stack libraries: React/Next.js, Python/FastAPI, Go, Rails, Rust","Advanced patterns: multi-project, team memory, CI integration","CLAUDE.md templates for solo and monorepo projects"],href:`https://edgelessai.gumroad.com/l/claude-memory-kit?${b}`,badge:"Popular"},{name:"The Prompt Engineering OS",price:"$29",description:"The complete system for writing AI prompts that work in production. 30 chapters, 8 template schemas, 100+ templates.",features:["30 chapters covering every prompt pattern","8 template schemas with fill-in-the-blank structure","100+ production-tested prompt templates","Covers Claude, GPT-4, Gemini, and open models"],href:`https://edgelessai.gumroad.com/l/prompt-engineering-os?${b}`,badge:null},{name:"Generative Art Starter Kit",price:"$29",description:"10 Python generators for pen plotters: flow fields, L-systems, Voronoi, spirals, reaction-diffusion. Each with parameter guides, example SVGs, and AI scoring rubrics from 105+ experiments.",features:["10 generators with source code, parameter guides, and 3 example outputs each","SVG optimization for pen plotters: stroke ordering, travel minimization","AI scoring rubric for evaluating generative art quality","Print-ready export: A4, A3, letter sizes with plotter setup guides"],href:`https://edgelessai.gumroad.com/l/gen-art-starter?${b}`,badge:"New",comingSoon:!1,slug:"gen-art-starter"},{name:"Production MCP Server Kit",price:"$29",description:"Take MCP servers past the tutorial stage. Auth middleware, rate limiting, Docker deployment, health checks, and error handling patterns from running 4+ MCP servers in production.",features:["Auth middleware: API key validation and OAuth2 token checking","Rate limiting, usage tracking, and health check endpoints","Docker + compose deployment configs with monitoring","3 production server examples: filesystem, database, external API"],href:`https://edgelessai.gumroad.com/l/production-mcp-kit?${b}`,badge:"New",comingSoon:!1,slug:"production-mcp-kit"},{name:"AI Code Review Playbook",price:"$24",description:"Systematic AI-powered code review that catches security vulnerabilities, performance issues, and logic errors before they ship.",features:["Review checklists and prompt templates for Claude/GPT","GitHub Actions and CI/CD integration guides","Security vulnerability and performance issue detection","Built from real experience reviewing thousands of PRs"],href:`https://edgelessai.gumroad.com/l/uacjr?${b}`,badge:null},{name:"Digital Product Launch Toolkit",price:"$24",description:"The exact process used to ship 18 digital products as a solo developer. Gumroad page templates, pricing strategy, launch checklists, and the daily shipping workflow.",features:["3 Gumroad page layouts: simple, detailed, and premium tiers","Pricing strategy guide: why $9/$14/$19/$24/$29/$39 tiers work","18-step launch checklist from idea to live listing","Cross-sell and bundle strategies with real revenue examples"],href:`https://edgelessai.gumroad.com/l/launch-toolkit?${b}`,badge:"New",comingSoon:!1,slug:"launch-toolkit"},{name:"n8n AI Workflow Templates",price:"$24",description:"5 importable n8n workflows that connect AI to real business processes. YouTube monitoring, RSS intelligence, AI code review, content embedding, and scheduled health checks.",features:["5 ready-to-import n8n workflow JSON files","YouTube monitor -> Claude summary -> email digest pipeline","RSS aggregator -> AI analysis -> Telegram notification","Docker n8n setup guide with environment configuration"],href:`https://edgelessai.gumroad.com/l/n8n-ai-workflows?${b}`,badge:"New",comingSoon:!1,slug:"n8n-ai-workflows"},{name:"MCP Server Starter Kit",price:"$24",description:"TypeScript and Python templates for building MCP servers. Go from zero to a running server in under an hour.",features:["TypeScript and Python server templates","8-chapter guide from architecture to deployment","3 working example servers: file search, database query, API proxy","Complete build-to-deploy walkthrough"],href:`https://edgelessai.gumroad.com/l/lixicg?${b}`,badge:null},{name:"Obsidian + Claude Code Setup Kit",price:"$19",description:"Turn Obsidian into an AI-powered development environment with pre-configured vault, Claude Code integration, and workflow automations.",features:["Pre-configured vault with Claude Code integration","CLAUDE.md templates and hook configurations","Custom templates and plugin recommendations","Complete knowledge management system for AI developers"],href:`https://edgelessai.gumroad.com/l/fyuwpn?${b}`,badge:null},{name:"Prompt Testing Framework",price:"$19",description:"Regression testing, A/B comparison templates, and quality scoring rubrics for AI prompts. Built for teams shipping AI features.",features:["Regression testing and A/B comparison templates","Quality scoring rubrics with structured evaluation criteria","Test harnesses for Claude, GPT, and Gemini","Repeatable, measurable prompt quality workflows"],href:`https://edgelessai.gumroad.com/l/yrail?${b}`,badge:null},{name:"Autonomous Agent Safety Patterns",price:"$19",description:"Hard-won guardrails from an agent that lost $252 of real money. Financial verification protocols, destructive operation prevention, scope containment, and the incident response playbook.",features:["Full post-mortem: the $252 USDC loss and what changed after","10 anti-patterns with production fixes and hook implementations","Financial transaction verification protocol (test small, verify, confirm)","Scope containment patterns: keeping agents within boundaries"],href:`https://edgelessai.gumroad.com/l/agent-safety-patterns?${b}`,badge:"New",comingSoon:!1,slug:"agent-safety-patterns"},{name:"Claude Code Hooks Deep Dive",price:"$19",description:"15 production hooks beyond the basics. The damage-control hook that blocks destructive commands. The verify-completion hook that won't let you lie about finishing. Session init, memory flush, pre-commit guards.",features:["15 battle-tested hooks with full source and walkthroughs","damage-control.py: the hook that saved the codebase from rm -rf","Hook composition patterns: chaining, conditional, env-aware","Template hooks for common scenarios you can customize in minutes"],href:`https://edgelessai.gumroad.com/l/hooks-deep-dive?${b}`,badge:"New",comingSoon:!1,slug:"hooks-deep-dive"},{name:"CLAUDE.md Template Pack",price:"$14",description:"14 battle-tested CLAUDE.md templates for every project type. Drop one into your repo and start building.",features:["14 templates: iOS, Android, ML, API, DevOps, Next.js, and more","CLI Tools, Monorepos, and Game Dev configurations","Embedded/IoT, Security Audits, and Open Source templates","Startup MVP and Technical Writing presets"],href:`https://edgelessai.gumroad.com/l/kszapk?${b}`,badge:null},{name:"Hooks Library",price:"$14",description:"24 production-ready hooks across 6 categories. Drop in, configure, ship.",features:["Quality hooks: linting, testing, secrets detection","Safety hooks: damage control, backup, force-push guard","Integration hooks: Slack, Telegram, Linear, Obsidian","AI hooks: context preload, completion verify, cost tracking"],href:`https://edgelessai.gumroad.com/l/ztaflt?${b}`,badge:null},{name:"Quick Reference Cards",price:"$9",description:"Printable cheat sheets for prompt patterns, Claude Code shortcuts, MCP tool reference, and common workflows.",features:["Prompt pattern and system prompt reference cards","Claude Code shortcuts and slash commands","Token optimization and temperature settings guide","PDF and markdown formats, pin-next-to-monitor ready"],href:`https://edgelessai.gumroad.com/l/dihxts?${b}`,badge:null},{name:"Claude Memory Kit",price:"Free",description:"Start here. Drop-in memory template for Claude Code. Persists context, feedback, and project knowledge across conversations.",features:["4 memory types: user, feedback, project, reference","MEMORY.md index auto-loaded each session","CLAUDE.md snippet for instant setup","Real-world examples included"],href:"https://github.com/edgeless-ai/claude-memory-kit?utm_source=edgelesslab&utm_medium=website&utm_campaign=products",badge:"Open Source",repoUrl:"https://github.com/edgeless-ai/claude-memory-kit"}];y.PLOTTER.pieces,y.PLOTTER.factories,y.PLOTTER.factories,y.PLOTTER.factories,y.PLOTTER.pieces,y.PLOTTER.factories,y.PLOTTER.pieces,y.PLOTTER.best,y.PLOTTER.factories,y.PLOTTER.pieces,y.PLOTTER.kept,y.PLOTTER.kept,y.PLOTTER.factories,y.PLOTTER.pieces,y.PLOTTER.best,y.PLOTTER.kept;let w=[{slug:"meta-ai-style-guide",title:"Meta's AI Has a Style Guide. Here's What I Took From It.",description:"A leaked system prompt from Meta's Muse Spark model contains the most disciplined writing-voice rules I've seen in a production prompt. Five rules I imported, one I rewrote, one I'm still arguing with.",date:"2026-04-10",tags:["Prompt Engineering","AI Agents","System Prompts"],readTime:"8 min",productSlug:"prompt-engineering-os",content:`
...
`},{slug:"shipped-7-products-in-7-days",productSlug:"launch-toolkit",isLaunch:!0,title:"I Shipped 7 Digital Products in 7 Days. Here's Exactly How.",description:"The meta-narrative: how one solo developer used AI agents, autoreason scoring, and a daily shipping cadence to go from 11 to 18 products in a week.",date:"2026-04-09",tags:["Solo Dev","Products","Process"],readTime:"6 min",content:`
...
The best generative art doesn't look generative. It looks like someone made a deliberate choice at every point. The algorithm just happens to be the one making those choices.
    `.trim()},{slug:"agents-that-talk-to-each-other",productSlug:"multi-agent-blueprint",isLaunch:!0,title:"How I Run 5 AI Agents That Talk to Each Other",description:"A dispatch agent routes tasks to specialist workers. They communicate through a real-time bus and async inboxes. The architecture, and why most multi-agent frameworks get it wrong.",date:"2026-04-07",tags:["Multi-Agent","Architecture","Claude Code"],readTime:"7 min",content:`
...
The full workflow JSON files, setup guides, and customization instructions are in the [n8n AI Workflow Templates](/products) on the products page.
    `.trim()},{slug:"mcp-servers-break-in-production",productSlug:"production-mcp-kit",isLaunch:!0,title:"Most MCP Servers Break in Production. Here's Why.",description:"400+ MCP servers exist. Most work in demos and fail under real load. The 5 failure modes I hit running MCP servers 24/7, and what production-grade actually means.",date:"2026-04-05",tags:["MCP","Infrastructure","Production"],readTime:"5 min",content:`
...
The goal isn't to build the most complex system. It's to build the most useful one, with the least moving parts.
    `.trim()},{slug:"how-claude-code-memory-works",title:"How Claude Code Memory Actually Works",description:"Claude forgets everything between sessions. Here's how file-based memory fixes that, and why it changes how you work with AI.",date:"2026-03-21",tags:["Claude Code","Memory","Developer Tools"],readTime:"6 min",productSlug:"claude-memory-kit",content:`
